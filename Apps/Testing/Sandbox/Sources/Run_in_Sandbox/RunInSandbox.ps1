...
function New-WSB {
    ...
    # Always map D:\Applications from host to C:\Applications in sandbox
    Add-Content -LiteralPath $Sandbox_File_Path -Value "        <MappedFolder>"
    Add-Content -LiteralPath $Sandbox_File_Path -Value "            <HostFolder>D:\Applications</HostFolder>"
    Add-Content -LiteralPath $Sandbox_File_Path -Value "            <SandboxFolder>C:\Applications</SandboxFolder>"
    Add-Content -LiteralPath $Sandbox_File_Path -Value "            <ReadOnly>false</ReadOnly>"
    Add-Content -LiteralPath $Sandbox_File_Path -Value "        </MappedFolder>"

    # Always map D:\Applications from host to C:\Applications in sandbox
    Add-Content -LiteralPath $Sandbox_File_Path -Value "        <MappedFolder>"
    Add-Content -LiteralPath $Sandbox_File_Path -Value "            <HostFolder>D:\Sandbox\PS7Install</HostFolder>"
    Add-Content -LiteralPath $Sandbox_File_Path -Value "            <SandboxFolder>C:\PS7</SandboxFolder>"
    Add-Content -LiteralPath $Sandbox_File_Path -Value "            <ReadOnly>false</ReadOnly>"
    Add-Content -LiteralPath $Sandbox_File_Path -Value "        </MappedFolder>"
