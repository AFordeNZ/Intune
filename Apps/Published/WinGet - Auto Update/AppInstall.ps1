...
.DESCRIPTION
    Script to install Winget-AutoUpdate-Intune
...
$AppName = "Winget-AutoUpdate-Intune"
$AppVersion = "1.06.0036"
$Installer = "1.06.0036.msi" # assumes the .exe or .msi installer is in the Files folder of the app package.
