...
.DESCRIPTION
    Script to install Visual Studio Code Insiders
...
$AppVersion = "1.100.0"
$Installer = "VSCodeSetup-x64-1.100.0-insider.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
