...
$AppName = "Freeplane"
$AppVersion = "1.12.10"
$Installer = "Freeplane-Setup-1.12.10.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
$InstallArguments = "/VERYSILENT /NORESTART /SUPPRESSMSGBOXES" # Optional
