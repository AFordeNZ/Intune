<#
.SYNOPSIS
    Tailscale App Install Script

.DESCRIPTION
    Script to install Tailscale
...
$AppName = "Tailscale"
$AppVersion = "1.84.2"
$Installer = "tailscale-setup-1.84.2.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
