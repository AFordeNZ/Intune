...
$AppName = "Microsoft Windows Desktop Runtime - 8.0.17"
$AppVersion = "8.0.17.34917"
$Installer = "windowsdesktop-runtime-8.0.17-win-x64.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
