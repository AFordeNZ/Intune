<#
.SYNOPSIS
    Wireshark Application Install Script

.DESCRIPTION
    Script to install Wireshark
...
$AppName = "Wireshark"
$AppVersion = "4.4.7"
$Installer = "Wireshark-4.4.7-x64.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
