    <#
    .SYNOPSIS
    Microsoft PowerShell 7.5 Install.

    .DESCRIPTION
    Script to install or uninstall Microsoft PowerShell 7.5.
    ...
    $AppVersion       = "7.5.0.0"
    $Installer        = "PowerShell-7.5.0-win-x64.msi" # assumes the .exe or .msi installer is in the Files folder of the app package.
