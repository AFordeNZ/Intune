...
.DESCRIPTION
    Script to install Python 3.13.3
...
$AppName = "Python 3.13.3 (64-bit)"
$AppVersion = "3.13.3"
$Installer = "python-3.13.3-amd64.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
$InstallArguments = "/quiet InstallAllUsers=1 PrependPath=1 " # Optional
