...
.DESCRIPTION
    Script to install Microsoft Power BI Desktop
...
$AppName = "Microsoft Power BI Desktop"
$AppVersion = "2.142.928.0"
$Installer = "PBIDesktopSetup_x64.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
$InstallArguments = "-quiet ACCEPT_EULA=1 LANGUAGE=en-US" # Optional
